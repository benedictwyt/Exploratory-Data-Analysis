...
## Equiment Losing Rate

This chart to visualize and analyze the aircraft losing rate compared to the tank losing rate. The formula used to calculate the losing rate is (new lost equipment / total lost equipment) * 100%. After seeing the graph, I conclude that relative more aircraft were destroyed at the early period of the war. 
